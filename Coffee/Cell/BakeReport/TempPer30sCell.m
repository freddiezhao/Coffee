...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        if (!_Label1) {
            ...
            _Label1.font = [UIFont systemFontOfSize:11.0];
        ...
        if (!_Label2) {
            ...
            _Label2.font = [UIFont systemFontOfSize:11.0];
        ...
        if (!_Label3) {
            ...
            _Label3.font = [UIFont systemFontOfSize:11.0];
        ...
        if (!_Label4) {
            ...
            _Label4.font = [UIFont systemFontOfSize:11.0];
        ...
        if (!_Label5) {
            ...
            _Label5.font = [UIFont systemFontOfSize:11.0];
        ...
        if (!_Label6) {
            ...
            _Label6.font = [UIFont systemFontOfSize:11.0];
