...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        if (!_beanName) {
//            UILabel *beanNameText = [[UILabel alloc] initWithFrame:CGRectMake(20/WScale, 12/HScale, 50/WScale, 20/HScale)];
//            beanNameText.textColor = [UIColor colorWithHexString:@"999999"];
//            beanNameText.font = [UIFont systemFontOfSize:13.0];
//            beanNameText.textAlignment = NSTextAlignmentLeft;
//            beanNameText.text = LocalString(@"名称");
//            [self.contentView addSubview:beanNameText];

            
            _beanName = [[UILabel alloc] initWithFrame:CGRectMake(20/WScale, 12/HScale, 160/WScale, 20/HScale)];
            _beanName.textColor = [UIColor colorWithHexString:@"999999"];
            _beanName.font = [UIFont systemFontOfSize:13.0];
            _beanName.textAlignment = NSTextAlignmentLeft;
            _beanName.text = LocalString(@"名称");
...
//            [self.contentView addSubview:nationText];
            ...
            _nation = [[UILabel alloc] initWithFrame:CGRectMake(20/WScale, 40/HScale, 160/WScale, 20/HScale)];
...
//            [self.contentView addSubview:areaText];
            ...
            _area = [[UILabel alloc] initWithFrame:CGRectMake(20/WScale, 68/HScale, 160/WScale, 20/HScale)];
...
//            [self.contentView addSubview:altitudeText];
            ...
            _altitude = [[UILabel alloc] initWithFrame:CGRectMake(20/WScale, 96/HScale, 160/WScale, 20/HScale)];
...
//            [self.contentView addSubview:manorText];
            ...
            _manor = [[UILabel alloc] initWithFrame:CGRectMake(20/WScale, 124/HScale, 160/WScale, 20/HScale)];
...
//            [self.contentView addSubview:beanSpeciesText];
            ...
            _beanSpecies = [[UILabel alloc] initWithFrame:CGRectMake(203/WScale, 12/HScale, 160/WScale, 20/HScale)];
            ...
            _beanSpecies.text = LocalString(@"豆种");
...
//            [self.contentView addSubview:gradeText];
            ...
            _grade = [[UILabel alloc] initWithFrame:CGRectMake(203/WScale, 40/HScale, 160/WScale, 20/HScale)];
...
//            [self.contentView addSubview:processText];
            ...
            _process = [[UILabel alloc] initWithFrame:CGRectMake(203/WScale, 68/HScale, 160/WScale, 20/HScale)];
            ...
            _process.text = LocalString(@"处理方式");
...
//            [self.contentView addSubview:waterText];
            ...
            _water = [[UILabel alloc] initWithFrame:CGRectMake(203/WScale, 96/HScale, 160/WScale, 20/HScale)];
...
//            [self.contentView addSubview:weightText];
            ...
            _weight = [[UILabel alloc] initWithFrame:CGRectMake(203/WScale, 124/HScale, 160/WScale, 20/HScale)];
